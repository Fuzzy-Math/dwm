...
static const unsigned int gappw     = 7;       /* gap width between windows */
...
static const char *restartcmd[]  = { "killall", "dwm", "&" };
static const char *logoutcmd[]  = { "killall", "Xorg" };
static const char *rebootcmd[]  = { "shutdown", "-r", "now" };
...
static Key keys[] = {
	...
	{ Mod1Mask|ControlMask|ShiftMask, XK_Return, spawn,        {.v = restartcmd } },
	{ Mod1Mask|ControlMask|ShiftMask, XK_l,     spawn,         {.v = logoutcmd } },
	{ Mod1Mask|ControlMask|ShiftMask, XK_BackSpace, spawn,     {.v = rebootcmd } },
